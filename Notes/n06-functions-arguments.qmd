...
- Here we can see that the function implementation that was previously in the `temperature.c` file has now been moved to a separate `tempConversion.c` file.
    ...
    - This information is in a separate file as it is important to the files using the library rather than the library itself.
...
<!-- TODO: maybe add this section: # Recursion -->
