...
---
Instructions in this file are to be run in the same codespace as from the into to the terminal. Make sure to save your changes
...
2. Put `#!/bin/bash` at the start of the file. (this is sometimes called a shebang)
