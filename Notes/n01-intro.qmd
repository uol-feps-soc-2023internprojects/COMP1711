...
Files can also be uploaded to codespaces, this is in the dropdown options when you right click the file explorer.

![](/img/codespaceUpload.png){fig-alt="Image of the right click dropdown for the file explorer"}
